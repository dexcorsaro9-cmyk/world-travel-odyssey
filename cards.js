...
export const ALL_CARDS = [
  // ================= 🇮🇹 ITALIA (Pelle Toscana & Ceralacca) =================
  {
    ...
    material: MATERIALS.LEATHER, rarity: RARITY.LEGENDARY, airport: 'FCO - Roma',
  ...
  },
  {
    ...
    material: MATERIALS.LEATHER, rarity: RARITY.RARE, airport: 'FCO - Roma',
  ...
  },
  {
    ...
    material: MATERIALS.LEATHER, rarity: RARITY.COMMON, airport: 'NAP - Napoli',
  ...
  // ================= 🇯🇵 GIAPPONE (Acrilico High-Tech & Neon) =================
  {
    ...
    material: MATERIALS.ACRYLIC_NEON, rarity: RARITY.LEGENDARY, airport: 'HND - Tokyo',
  ...
  },
  {
    ...
    material: MATERIALS.ACRYLIC_NEON, rarity: RARITY.EPIC, airport: 'HND - Tokyo',
  ...
  },
  {
    ...
    material: MATERIALS.ACRYLIC_NEON, rarity: RARITY.RARE, airport: 'NRT - Tokyo',
  ...
  // ================= 🇺🇸 STATI UNITI (Titanio Nero & Chip) =================
  {
    ...
    material: MATERIALS.TITANIUM, rarity: RARITY.LEGENDARY, airport: 'JFK - New York',
  ...
  },
  {
    ...
    material: MATERIALS.TITANIUM, rarity: RARITY.EPIC, airport: 'JFK - New York',
  ...
  },
  {
    ...
    material: MATERIALS.TITANIUM, rarity: RARITY.RARE, airport: 'JFK - New York',
  ...
  // ================= 🇫🇷 FRANCIA (Seta Haute-Couture & Champagne) =================
  {
    ...
    material: MATERIALS.SILK, rarity: RARITY.LEGENDARY, airport: 'CDG - Parigi',
  ...
  },
  {
    ...
    material: MATERIALS.SILK, rarity: RARITY.EPIC, airport: 'CDG - Parigi',
  ...
  },
  {
    ...
    material: MATERIALS.SILK, rarity: RARITY.COMMON, airport: 'ORY - Parigi',
  ...
  // ================= 🇬🇧 REGNO UNITO (Tweed Savile Row & MI6) =================
  {
    ...
    material: MATERIALS.TWEED, rarity: RARITY.LEGENDARY, airport: 'LHR - Londra',
  ...
  },
  {
    ...
    material: MATERIALS.TWEED, rarity: RARITY.RARE, airport: 'LHR - Londra',
  ...
  // ================= 🇧🇷 BRASILE (Jacaranda & Piume Sambodromo) =================
  {
    ...
    material: MATERIALS.TROPICAL, rarity: RARITY.LEGENDARY, airport: 'GIG - Rio',
  ...
  },
  {
    ...
    material: MATERIALS.TROPICAL, rarity: RARITY.EPIC, airport: 'GIG - Rio',
  ...
  // ================= 🇨🇭 SVIZZERA (Acciaio Satinato & Orologeria) =================
  {
    ...
    material: MATERIALS.SWISS_STEEL, rarity: RARITY.LEGENDARY, airport: 'ZRH - Zurigo',
  ...
  },
  {
    ...
    material: MATERIALS.SWISS_STEEL, rarity: RARITY.RARE, airport: 'GVA - Ginevra',
  ...
  // ================= 🇪🇬 EGITTO (Papiro d'Oro & Lapislazzuli) =================
  {
    ...
    material: MATERIALS.PAPYRUS, rarity: RARITY.LEGENDARY, airport: 'CAI - Il Cairo',
  ...
  },
  {
    ...
    material: MATERIALS.PAPYRUS, rarity: RARITY.EPIC, airport: 'CAI - Il Cairo', requiresSacrifice: true,
  ...
  // ================= 🇰🇷 COREA DEL SUD (Cyber-Glass K-Pop) =================
  {
    ...
    material: MATERIALS.CYBER_GLASS, rarity: RARITY.LEGENDARY, airport: 'ICN - Seul',
  ...
  },
  {
    ...
    material: MATERIALS.CYBER_GLASS, rarity: RARITY.RARE, airport: 'ICN - Seul',
  ...
  // ================= 🇮🇸 ISLANDA (Ghiaccio Vulcanico & Ossidiana) =================
  {
    ...
    material: MATERIALS.VOLCANIC_ICE, rarity: RARITY.EPIC, airport: 'KEF - Reykjavik',
  ...
  // ================= 🇲🇽 MESSICO (Terracotta & Giada Maya) =================
  {
    ...
    material: MATERIALS.TERRACOTTA, rarity: RARITY.EPIC, airport: 'CUN - Cancún',
  ...
  // ================= 🇦🇺 AUSTRALIA (Opale & Barriera Corallina) =================
  {
    ...
    material: MATERIALS.OPAL, rarity: RARITY.EPIC, airport: 'CNS - Cairns',
  ...
  // ================= ⚠️ IMPREVISTI DOGANALI (Trappole Coperte Yu-Gi-Oh) =================
  {
    ...
    material: MATERIALS.LEATHER, rarity: RARITY.COMMON, airport: 'IMMIGRATION', isFacedown: true,
  ...
  },
  {
    ...
    material: MATERIALS.TITANIUM, rarity: RARITY.RARE, airport: 'CONTROL TOWER', isFacedown: true,
  ...
  },
  {
    ...
    material: MATERIALS.LEATHER, rarity: RARITY.COMMON, airport: 'MXP - Milano', isFacedown: true,
  ...
  // ================= ✈️ VOLI SPECIALI & DISCOVER =================
  {
    ...
    material: MATERIALS.ACRYLIC_NEON, rarity: RARITY.COMMON, airport: 'WORLD GATE',
  ...
  },
  {
    ...
    material: MATERIALS.LEATHER, rarity: RARITY.EPIC, airport: 'DIPLOMATIC CORPS',
